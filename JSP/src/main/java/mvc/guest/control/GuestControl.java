...
import mvc.guest.command.CommandUpdate;
...
public class GuestControl extends HttpServlet {
	...
	private void initCommand(){
		...
		commandMap.put("modify-form", new CommandSelect("modifyMessage.jsp") );
		commandMap.put("modify-do", new CommandUpdate("modifyConfirm.jsp") );
	}
